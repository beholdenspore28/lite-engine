...
static inline vector3 l_object_back(l_transform transform,
                                      unsigned int index, float magnitude) {
  return vector3_rotate(vector3_back(magnitude), transform.rotation[index]);
}

static inline vector3 l_object_right(l_transform transform,
                                       unsigned int index, float magnitude) {
  return vector3_rotate(vector3_right(magnitude), transform.rotation[index]);
}

static inline vector3 l_object_left(l_transform transform,
                                      unsigned int index, float magnitude) {
...
static inline vector3 l_object_down(l_transform transform,
                                      unsigned int index, float magnitude) {
