...
// just some helpful enumerations to make common tree breadths more readable
enum {
  COLLECTIONS_BINARY_TREE_LEFT,
  COLLECTIONS_BINARY_TREE_RIGHT,
};

enum {
  COLLECTIONS_QUAD_TREE_LEFT_BOTTOM,
  COLLECTIONS_QUAD_TREE_RIGHT_BOTTOM,
  COLLECTIONS_QUAD_TREE_LEFT_TOP,
  COLLECTIONS_QUAD_TREE_RIGHT_TOP,
};

enum {
  COLLECTIONS_OCT_TREE_LEFT_BOTTOM_BACK,
  COLLECTIONS_OCT_TREE_RIGHT_BOTTOM_BACK,
  COLLECTIONS_OCT_TREE_LEFT_TOP_BACK,
  COLLECTIONS_OCT_TREE_RIGHT_TOP_BACK,
  COLLECTIONS_OCT_TREE_LEFT_BOTTOM_FRONT,
  COLLECTIONS_OCT_TREE_RIGHT_BOTTOM_FRONT,
  COLLECTIONS_OCT_TREE_LEFT_TOP_FRONT,
